...
const ReportAnalysis: React.FC = () => {
  ...
  const analyzeReport = async () => {
    ...
    try {
      ...
      if (reportData.documentId && result.reviewId) {
        try {
          await supabase
            .from('documents')
            .update({ 
              related_report_review_id: result.reviewId,
        ...
        {analyzing ? (
          <div className="bg-white shadow-sm rounded-lg p-8">
            <div className="text-center">
              ...
              <h2 className="text-xl font-semibold text-gray-900 mb-2">Analyzing Report</h2>
              <p className="text-gray-600">
                Our AI is reviewing your report against HMRC criteria. This may take a moment...
              </p>
            </div>
          </div>
        ) : error ? (
